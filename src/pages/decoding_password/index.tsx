...
const DecodingPassword: React.FC = () => {
    ...
    const handleEncoding = async () => {
        try {
            const result = await window.electron.decryptFilePassword(filePath, password);
    ...
    return (
        ...
        >
            ...
            />
            <Button onClick={handleEncoding}>Giải mã</Button>
        </Stack>
    )
}

export default DecodingPassword;